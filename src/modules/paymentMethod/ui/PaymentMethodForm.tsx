...
import { PaymentMethodFormData } from '@modules/paymentMethod/model/PaymentMethodFormData'
...
function PaymentMethodForm({control, errors, images, setImages, setValue}: Props) {
